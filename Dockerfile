...
# workaround what seems to be missing min.js generation, don't know how to fix it to be min, so yeah.
RUN cp $DATAWRAPPER_ROOT_DIRECTORY/www/static/js/dw-2.0.js $DATAWRAPPER_ROOT_DIRECTORY/www/static/js/dw-2.0.min.js
